...
from MSFunctions.MSFunction_ROCKET import Calc_MIScore, find_dtw_dist, knn_clfcrossvalxv, knn_clfcrossvalxv_precomp, Create_input, Cal_numer, FindMerit_Score, Create_input_selected, Findaccuracy, FindCombsaccuracy, nptodf, nptodforder
from MSFunctions.MSFunctions import FindMerit_Score_knn
...
from MSFunctions.ReadDTW import ReadDTW
#%%
...
writefile = open("Results/"+Dataset_Name+"_ROCKET_knn.txt", "w+")
...
plt.savefig("Results/"+Dataset_Name+"_ROCKET_knn.png") 
...
writefile = open("Results/"+Dataset_Name+"_ROCKET_knn.txt", "a")
var_no = 2
for  i in range(0,n-1):
