...
from MSFunctions import Calc_MIScore, find_dtw_dist, knn_clfcrossvalxv, knn_clfcrossvalxv_precomp, Create_input, Cal_numer, FindMerit_Score, Create_input_selected, Findaccuracy, FindCombsaccuracy
from Load_Data import FindUEAXy, list_files

#%%
#For UEA Datasets
# Set the name of the Dataset
files = list_files(r"C:\PhD\PhD\TSDatasets\Multivariate_arff\JapaneseVowels\MTSDATA\Train")
files_test = list_files(r"C:\PhD\PhD\TSDatasets\Multivariate_arff\JapaneseVowels\MTSDATA\Test")
